<script lang="ts">
  ...
  $: alertClasses = `
    rounded-md p-4
    ${type === 'info' ? 'bg-blue-50 text-blue-800 dark:bg-blue-900 dark:text-blue-200' : ''}
          ...
          <div class="-mx-1.5 -my-1.5">
            <button
              ...
              class="inline-flex rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-offset-2
                ${type === 'info' ? 'bg-blue-50 text-blue-500 hover:bg-blue-100 focus:ring-blue-600 focus:ring-offset-blue-50 dark:bg-blue-900 dark:text-blue-300 dark:hover:bg-blue-800 dark:focus:ring-offset-blue-900' : ''}
                ${type === 'success' ? 'bg-green-50 text-green-500 hover:bg-green-100 focus:ring-green-600 focus:ring-offset-green-50 dark:bg-green-900 dark:text-green-300 dark:hover:bg-green-800 dark:focus:ring-offset-green-900' : ''}
                ${type === 'warning' ? 'bg-yellow-50 text-yellow-500 hover:bg-yellow-100 focus:ring-yellow-600 focus:ring-offset-yellow-50 dark:bg-yellow-900 dark:text-yellow-300 dark:hover:bg-yellow-800 dark:focus:ring-offset-yellow-900' : ''}
                ${type === 'error' ? 'bg-red-50 text-red-500 hover:bg-red-100 focus:ring-red-600 focus:ring-offset-red-50 dark:bg-red-900 dark:text-red-300 dark:hover:bg-red-800 dark:focus:ring-offset-red-900' : ''}"
              on:click={dismiss}
            >
