...
<ErrorBoundary>
    <main class="min-h-screen bg-gradient-to-b from-background to-background/50 text-black">
        <!-- Hero Section -->
        <section class="container mx-auto px-4 py-20" in:fade={{ duration: 1000 }}>
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <!-- Left Column - Text Content -->
                <div class="flex-1 text-left">
                    <h1 class="text-7xl tracking-wide font-extrabold mb-6 text-black">
