            ...
            <div>
                ...
                <div class="mt-1">
                    <input
                        ...
                        name="first_name"
                        id="first_name"
                        value={form?.data?.first_name ?? data.user.first_name}
            ...
            <div>
                ...
                <div class="mt-1">
                    <input
                        ...
                        name="last_name"
                        id="last_name"
                        value={form?.data?.last_name ?? data.user.last_name}
                        class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                    />
                </div>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <input
                        ...
                        name="phone"
                        id="phone"
                        value={form?.data?.phone ?? data.user.phone}
                        class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                    />
                </div>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    ...
                    >
                        <option 
                            value="user"
                            selected={form?.data?.role === 'user' || (!form?.data?.role && data.user.role === 'user')}
                        >
                            User
                        </option>
                        <option
                            value="admin"
                            selected={form?.data?.role === 'admin' || (!form?.data?.role && data.user.role === 'admin')}
                        >
                            Admin
                        </option>
                    </select>
