...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-4 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md" in:fade>
        <h2 class="mt-4 text-center text-2xl font-bold text-gray-900">Create your account</h2>
        <p class="mt-2 text-center text-base text-gray-600">Introduce yourself to get started.</p>
        <p class="mt-2 text-center text-sm text-gray-600">
            Or
            <a href="/sign-in" class="font-medium text-blue-600 hover:text-blue-500 underline">sign in to your existing account</a>
        </p>
        ...
        <form method="POST" class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 space-y-6" on:submit={handleSubmit} on:input={handleInput} autocomplete="off">
            ...
            <div class="mt-2 text-sm text-gray-500">
                ...
                <ul class="list-disc list-inside mt-1">
                    ...
                    <li class={/[^A-Za-z0-9]/.test(password) ? 'text-green-600' : ''}>Contain at least one special character</li>
                </ul>
            </div>
