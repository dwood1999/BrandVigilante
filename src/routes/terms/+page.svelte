	...
	<div class="prose max-w-none">
		...
		<section class="mb-8">
			...
			<ul class="list-disc pl-6 mt-4">
				...
				<li>Enforcement assistance</li>
				<li>Brand protection tools</li>
			</ul>
		</section>
		...
		<section class="mb-8">
			...
			<p>You retain all rights to any content you submit, post, or display on or through the Service. By submitting content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and distribute your content in connection with providing the Service.</p>
		</section>

		<section class="mb-8">
			<h2 class="text-2xl font-semibold mb-4">6. Prohibited Uses</h2>
